...
argv = require('optimist').usage("Filter output from adb logcat.\n\nUsage: noyd --logcat -w YourLogTag").demand('l').boolean('l').alias('l', 'logcat').describe('l', 'Start the android log stream.').alias('w', 'white').describe('w', 'Match to whiten.').argv;
